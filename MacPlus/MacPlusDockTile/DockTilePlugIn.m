...
- (void)setDockTile:(NSDockTile *)dockTile {
    if (dockTile) {
        ...
        self.updateObserver = [[NSDistributedNotificationCenter defaultCenter] addObserverForName:@"com.w0lf.MacPlusDockTileUpdate" object:nil queue:nil usingBlock:^(NSNotification *notification) {
